...
import { BrowserNoCachePolicyFactory } from "./BrowserNoCachePolicyFactory";
...
export abstract class StorageURL {
   ...
   *
   * @static
   * @param {Credential} credential Such as AnonymouseCredential, SharedKeyCredential or TokenCredential.
  ...
  public static newPipeline(
    ...
    factories.push(new BrowserNoCachePolicyFactory());
