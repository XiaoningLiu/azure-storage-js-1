 ...
 */
export interface DataLakeStorageClientOptions extends ServiceClientOptions {
  /**
...
export interface PathCreateOptionalParams extends msRest.RequestOptionsBase {
   ...
   * "/{filesysystem}/{path}".  If "x-ms-properties" is specified, the properties will overwrite
   * the existing properties; otherwise, the existing properties will be preserved. This value must
   * be a URL percent-encoded string. Note that the string may only contain ASCII characters in the
